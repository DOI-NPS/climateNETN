...
<br>
<br>
Climate data are compiled and visualized using functions in the <a href="https://github.com/doi-nps/climateNETN/">climateNETN R package</a>. Each function in the climateNETN package has help documentation with examples. Note that, among other features, you can use the 30-year normal instead of the 20th century normal as the baseline, can use scientific units (e.g., F and mm), and can change color palettes and year ranges in plots within climateNETN functions. 
</p>
<br>
</details>
