...
```{r fig.height=7, fig.width=13, results = 'asis', fig.cap = anom_comp_cap1, fig.alt = paste0("Top plot is ", get_alt_text(temp_comp), " Bottom plot is ", get_alt_text(temp_anom)) }
...
```{r fig.height=7, fig.width=13, results = 'asis', fig.cap = anom_comp_cap1, fig.alt = paste0("Top plot is ", get_alt_text(ppt_comp), " Bottom plot is ", get_alt_text(ppt_anom))}
...
```{r fig.height=7, fig.width=13, results = 'asis', fig.cap = drgt_cumppt_cap1, fig.alt = paste0("Top plot is ", get_alt_text(drgt), " Bottom plot is ", get_alt_text(pptcum))}
...
<details open><summary class='drop'>Temperature</summary>
```{r fig.height=6, fig.width=13, results = 'asis', fig.cap = anom_cap5, fig.alt = get_alt_text(pclimanom)}
yr1 = yr_current - 4
pclimanom <- 
...
```{r fig.height=6, fig.width=13, results = 'asis', fig.cap = anom_cap5, fig.alt = get_alt_text(pclimanomp)}
pclimanomp <- 
...
<details open><summary class='drop'>Drought Condition</summary>
```{r fig.height=7.5, fig.width=12.1, results = 'asis', fig.cap = drgt_cap5, fig.alt = paste0("Top plot is ", get_alt_text(temp), " Middle plot is ", get_alt_text(ppt), " Bottom plot is ", get_alt_text(drgt))}
...
```{r fig.height=7, fig.width=13, results = 'asis', fig.cap = cum_cap5, fig.alt = get_alt_text(pclimcumppt)}
pclimcumppt <-
...
```{r fig.height=6.5, fig.width=12.05, results = "asis", fig.cap = temp_capT, fig.alt = get_alt_text(pclimt)}
pclimt <- 
...
```{r fig.height=6.5, fig.width=13, results = 'asis', fig.cap = anom_capT, fig.alt = get_alt_text(pclimanom_all)}
pclimanom_all <- 
...
```{r fig.height=6.5, fig.width=12.05, results = 'asis', fig.cap = ppt_capT, fig.alt = get_alt_text(pclimtrend_all)}
pclimtrend_all <- 
plotClimTrend(park = parkcode, years = 1895:yr_current,
...
```{r fig.height=6.5, fig.width=13, results = 'asis', fig.cap = anom_capT, fig.alt = get_alt_text(pclimtrendp_all)}
pclimtrendp_all <- 
...
```{r fig.height=6.5, fig.width=12.1, results = 'asis', fig.cap = drgt_capT, fig.alt = get_alt_text(drgt_all)}
drgt_all <- 
